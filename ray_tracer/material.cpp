...
void MaterialBuilder::loadMaterials() {
    ...
    MaterialBuilder::addMaterial({"random_color", {1.f, 1.f, 1.f}, {0.5f, 0.6f, 0.3f}, glm::vec3{-0.5f}, 2.f, 0.f});
    MaterialBuilder::addMaterial({"mirror", {1.f, 1.f, 1.f}, {0.5f, 0.6f, 0.3f}, glm::vec3{0.5f}, 0.9f, 1.f});
}
